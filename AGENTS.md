...
> **Skills (não-Claude):** onde este documento diz “invocar/invoque a skill `X`” ou cita uma skill na tabela de dispatch, **leia e siga `skills/X/SKILL.md`** (o conteúdo é o mesmo; só a forma de carregar muda).
