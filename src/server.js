...
- wiki_search → use this when querying the LLM to search for past decisions, sessions, setups, or concepts across the workspace. Highly recommended before proposing new setups.
